        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    con.Open();
                    string query = "insert into dishes ([rest_id],[subrest_id],[cate_id],[dishname],[description],[price],[image]) values('" + Session["rest_id"] + "','"+ Session["subrest_id"].ToString() +"','" + DropDownList1.SelectedValue.ToString() + "','" + txtd_name.Text.ToString() + "','" + txtabout.Text.ToString() + "','" + txtprice.Text.ToString() + "','" + path.ToString() + "')";
