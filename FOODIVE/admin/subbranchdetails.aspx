<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="subbranchdetails.aspx.cs" Inherits="FOODIVE.admin.subbranchdetails" %>
...
<head runat="server">
    ...
    <title>FOODIVE | Sub-branch Details</title>
    <style>
        *{
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Sub-branch Details</h4>
                                </div>
                                        ...
                                        <tbody>
                                           <% if (subrest_id.Count == 0)
                                            ...
                                            <tr>    
                                                ...
                                                <td><% Response.Write("<a href='delete_subrestaurant.aspx?subres_del=" + subrest_id[i] + "' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-trash-o' style='font-size:16px'></i></a><a href='update_subrestaurant.aspx?subres_upd=" + subrest_id[i] + "' class='btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5'><i class='fa fa-edit'></i></a>"); %></td>
                                            </tr>
                                            <%}
  }%>
                                        </tbody>
