<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="all_users.aspx.cs" Inherits="FOODIVE.admin.all_users" %>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li><a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-delicious f-s-20 color-warning"></i><span class="hide-menu">Categories</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="all_category.aspx">Add Categories</a></li>
                            </ul>
                        </li>
